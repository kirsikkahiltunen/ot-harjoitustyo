...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahentaa_saldoa_oikein_3(self):
        self.kortti.syo_edullisesti()
    ...
    def test_syo_edullisesti_toimii_kun_saldoa_vain_edullisen_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_syo_maukkaasti_toimii_kun_saldoa_vain_maukkaan_lounaan_verran(self):
